...
```javascript
iterAbs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-abs/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/math-iter-special-abs/actions/workflows/test.yml?query=branch:v0.2.1
